...
if (!$raw_data) {
	...
	if (isset($data[$file])) {
		...
		$appvars['page']['title'] = "PHP: $version Expected Test Failure Report for $file";
		$appvars['page']['head']  = "Expected Test Failure Report for $file ('$title')";
...
HTML;
		...
		$content .= <<< HTML
<tr>
 <td><a href="/viewer.php?version=$version&amp;func=expected_tests&amp;file=$urlfile">$file</a></td>
 <td>$title</td>
</tr>
HTML;
